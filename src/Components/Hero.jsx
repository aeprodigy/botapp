...
const Hero = () => {
  return (
    <div class="bg-gradient-to-r from-violet-200 to-pink-200 min-h-screen pt-8">
      <h2 className="text-center text-white text-2xl pt-4">Hi, this is Your Virtual</h2>
      ...
      <div className="flex justify-center items-center container mx-auto pt-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-xl shadow-lg ">
            <div className="p-5 flex flex-col ">
              <div className="rounded-xl overflow-x-hidden text-center flex justify-center">
                <FaFacebookF />
              </div>
            </div>
          </div>
